...
use function Autil\_, Autil\filter, Autil\concat, Autil\joinWith, Autil\match, Autil\split, Autil\pretty, Autil\toArray, Autil\replace;
...
class RegExpO{
   ...
   ***/
   ...
   static function getFlags($str){
      ...
      preg_match($regex, $str, $matches);p
